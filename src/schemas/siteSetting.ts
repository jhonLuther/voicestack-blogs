    ...
    fields: [
      {
        ...
        title: 'Site Title',
        type: 'string',
        description: 'The main title of the site, used in SEO and browser title bars.',
      ...
      },
      {
        ...
        type: 'text',
        description: 'The description of your site, usually used in the meta description for SEO.',
      ...
      },
      {
        ...
        title: 'Site URL',
        type: 'url',
        description: 'The main URL of your site, used for SEO and structured data.',
      },
      {
        name: 'favicon',
        title: 'Favicon',
          ...
          fields: [
            {
              ...
              title: 'Platform',
              type: 'string',
              description: 'The name of the social media platform (e.g., Twitter, LinkedIn)',
            },
            {
              name: 'url',
              title: 'URL',
      ...
      },
      {
        ...
        title: 'JSON-LD',
        type: 'text',
        description: 'Custom JSON-LD structured data for SEO. Use this to inject JSON-LD data on the site.',
        options: {
          language: 'json',
        },
      },
      ...
      },
      {
        ...
        type: 'array',
        description: 'Optional extra meta tags for SEO (e.g., robots, viewport, etc.)',
        of: [{ 
          type: 'object', 
          fields: [
            {
