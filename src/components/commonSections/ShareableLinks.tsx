      ...
      <div className='flex gap-6'>
        ...
        >
          <div className='cursor-pointer hover:bg-zinc-200 rounded-md p-1 transition duration-200 ease-in-out'>
            <svg className='group-hover:text-zinc-800 text-zinc-500' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <Link
          ...
          target="_blank"
          rel=" noreferrer"
          title="facebook" className='group'
        >
          <div className='cursor-pointer hover:bg-zinc-200 rounded-md p-1 transition duration-200 ease-in-out'>
            <svg className='group-hover:text-zinc-800 text-zinc-500' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          title="twitter" className='group'
        >
          <div className='cursor-pointer hover:bg-zinc-200 rounded-md p-1 transition duration-200 ease-in-out'>
            <svg className='group-hover:text-zinc-800 text-zinc-500' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M15.2718 1.58659H18.0831L11.9414 8.60617L19.1666 18.1582H13.5093L9.07828 12.365L4.00821 18.1582H1.19528L7.76445 10.65L0.833252 1.58659H6.63418L10.6394 6.88187L15.2718 1.58659ZM14.2852 16.4756H15.8429L5.78775 3.18087H4.11614L14.2852 16.4756Z" fill="currentColor" />
            </svg>
          </div>
        </Link>
      </div>
