              ...
              <div className='flex flex-col md:flex-row gap-4 md:gap-12 content-center items-center justify-between' key={i}>
                <div className='flex md:px-0 px-0 flex-1 gap-8 max-w-[731px]'>
                  <div className='flex flex-col gap-y-6 md:gap-y-8'>
                    ...
                    <div>
                      <p className="text-zinc-900 text-2xl lg:text-4xl font-bold leading-[1.1] tracking-[-0.72px] font-manrope">{testimonialItem.testimonialName}</p>
                      <p className="mt-4 text-zinc-700 text-base lg:text-2xl leading-[1.6] md:leading-[1.4]">
