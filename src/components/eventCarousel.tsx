                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 gap-4 self-center w-full">
                      <div className="border-b border-[#33333333] pb-4">
                        <H4Large
                          className={`group-hover: group-hover: line-clamp-3 text-ellipsis overflow-hidden`}
                        >
                      ...
                      <div className="flex md:flex-row  flex-col justify-between items-center ">
                        <div className="flex items-center gap-6">
                          ...
                          <div className="flex items-center">
                            <span className="">
                              {`${formatDateShort(events.eventStartDate, true)} - ${formatDateShort(events.eventEndDate)} `}
                            </span>
                            <span>
