            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className={`flex flex-col gap-3 justify-between py-0 transition-all duration-300 ease-linear`}>
                ...
                lg:relative transition-all duration-300 ease-in-out ${headerFixed ? 'lg:my-2 my-2' : 'lg:my-4 my-2'}`}>
                  <Anchor href={normalizePath(homeUrl)} className="text-2xl font-extrabold bg-gradient-text bg-clip-text text-transparent font-monrope tracking-tighterText">
                    {/* <ClubLogo/>  */}
                    <GrowthClubLogo />
                  </Anchor>
                  <div className={`flex lg:gap-10   justify-between rounded-xl items-center`}>
                    {!isMobile && <div className='group relative py-4' >
                    <Anchor  href={generateHref(locale, siteConfig.categoryBaseUrls.base)}   className='text-zinc-500 flex items-center gap-[6px] cursor-pointer text-base hover:text-zinc-300'>
                      <span>
                      {`Topics`}
                      </span>
