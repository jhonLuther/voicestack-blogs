...
const Header = () => {
  ...
  return (
    <>
    <ProgressBar/>
    <header className={`fixed w-full top-0 left-0 z-10 transition-all duration-300 ease-linear ${headerFixed && '!fixed w-full !top-[-44px] left-0'}`}>
      ...
      <div className={`z-10 bg-zinc-900 text-white border-b border-zinc-800 px-4  `}>
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col gap-3 justify-between py-[10px] lg:py-6">
