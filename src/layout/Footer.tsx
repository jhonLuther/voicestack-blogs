...
const Footer = ({ className }) => {
  ...
  const sections = [
...

    {
      ...
      links: [
        ...
        {
          name: 'Login',
          url: 'https://id.carestack.com/Account/Domain',
          external: true,
        },
        {
          name: 'Features',
          url: 'https://carestack.com/dental-software/features',
          external: true,
        },
        {
          name: 'Onboarding',
          url: 'https://carestack.com/support/onboarding',
          external: true,
        },
        {
          name: 'Support',
    ...
    },
    {
      ...
      links: [
        ...
        {
          name: 'Events',
          url: 'https://carestack.com/company/events',
          external: true,
        },
        {
          name: 'Press',
          url: 'https://carestack.com/company/press',
          external: true,
        },
        {
          name: 'Contact',
          url: 'https://carestack.com/company/contact',
          external: true,
        },
      ],
    },
  ...
  return (
    <footer
      className={`bg-black text-white pt-12 md:pt-24 pb-12 px-4 ${className}`}
    >
      <Wrapper className="container mx-auto max-w-7xl flex flex-col gap-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-6 border-t border-[#3F3F46]">
          <span className="hover:text-zinc-300 text-zinc-500 text-center md:text-left text-xs md:text-[15px] leading-[1.62]">
            &copy;{' '}
