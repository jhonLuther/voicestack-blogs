    ...
    <Section className='bg-gray-900 justify-center !py-0'>
      ...
      {showTags && (
        <div className="flex flex-row gap-6 pt-6 md:pt-6 pb-6 w-full items-center">
          ...
          <Link href={`/browse`} className='text-[14px] font-medium leading-[1.5] text-zinc-500 flex items-center gap-x-1'>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.99996 18.8334C14.6023 18.8334 18.3333 15.1024 18.3333 10.5001C18.3333 5.89771 14.6023 2.16675 9.99996 2.16675C5.39758 2.16675 1.66663 5.89771 1.66663 10.5001C1.66663 15.1024 5.39758 18.8334 9.99996 18.8334Z" stroke="#71717A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
